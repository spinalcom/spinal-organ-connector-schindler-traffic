...
import {
  InputDataEndpointGroup as IInputDataEndpointGroup,
...
export class InputDataEndpointGroup implements IInputDataEndpointGroup {
  public id: string;
  public name: string;
  public type: string;
  public path: string;
  ...
  constructor(
    name = 'endpointGroup',
    type = 'endpointGroup',
    id = genUID('InputDataEndpointGroup'),
    path = ''
  ) {
